...
from hamacho.plug_in.models.components import (
    DynamicBufferModule,
    FeatureExtractor,
    KCenterGreedy
)
from hamacho.plug_in.models.patchcore.anomaly_map import AnomalyMapGenerator
...
class PatchcoreModel(DynamicBufferModule, nn.Module):
    ...
    def forward(
        self,
        input_tensor: Tensor,
        explicit_trained_data: Optional[Dict[str, Tensor]] = None,
        ...
        if explicit_trained_data is not None:
            memory_bank = explicit_trained_data["model.memory_bank"]
