...
from hamacho.core.post_processing.normalization.cdf import normalize
...
class CdfNormalizationCallback(Callback):
    ...
    def on_validation_epoch_start(
        ...
        """
        logger.info(
            "Collecting the statistics of the normal training data to normalize the scores."
        )
    ...
    def _collect_stats(self, trainer: Trainer, pl_module: AnomalyModule):
        ...
        """
        predictions = Trainer(accelerator=trainer.accelerator).predict(
