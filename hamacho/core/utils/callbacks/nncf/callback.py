...
from hamacho.core.utils.callbacks.nncf.utils import InitLoader
from hamacho.core.utils.callbacks.nncf.utils import wrap_nncf_model
...
class NNCFCallback(Callback):
    ...
    def on_train_end(
        ...
        optimize_command = (
            "mo --input_model " + onnx_path + " --output_dir " + self.export_dir
        )
